...
public class SteppingStone5_Recipe {
     ...
     */
		...
		/* OLGA: this is a constructor that does not have parameters */
    public SteppingStone5_Recipe( ) {
		...
		/* OLGA: this is a constructor that has parameters */
    public SteppingStone5_Recipe(String recipeName, int servings, 
    	ArrayList<String> recipeIngredients, float totalRecipeCalories) 
    ...
    public void printRecipe() {
         ...
         */
			...
			System.out.println("Ingredients:" + this.recipeIngredients);
